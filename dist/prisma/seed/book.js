...
const book = async () => {
    const { cat1, cat2, cat3, cat5 } = await (0, category_1.category)();
    const { alviArdhi, gramedia, andiPublisher, gagasmedia, dapurkata } = await (0, publisher_1.publisher)();
    const { tereLiye, alviSyahrin, anselWatra, author13 } = await (0, author_1.author)();
    const book1 = await seed_1.prisma.book.create({
        data: {
    ...
    const book2 = await seed_1.prisma.book.create({
        data: {
    ...
    const book4 = await seed_1.prisma.book.create({
        data: {
    ...
    const book5 = await seed_1.prisma.book.create({
        data: {
